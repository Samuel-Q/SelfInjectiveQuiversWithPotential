...
{
    public class PredefinedCobwebDialog : CustomDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "PredefinedCobwebDialog";
            this.Text = "Load cobweb";

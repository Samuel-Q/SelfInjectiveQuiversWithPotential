...
{
    [TestFixture]
    public class RepeatingCompositionGeneratorTestFixture
    {
        RepeatingCompositionGenerator CreateGenerator(int numRepetitions)
        {
            return new RepeatingCompositionGenerator(numRepetitions);
        }
        ...
        {
            Assert.That(() => new RepeatingCompositionGenerator(numRepetitions), Throws.InstanceOf<ArgumentOutOfRangeException>());
        }
        ...
        public static IEnumerable<TestCaseData> GenerateCompositions_Works_TestCase()
        {
        ...
        [TestCaseSource(nameof(GenerateCompositions_Works_TestCase))]
